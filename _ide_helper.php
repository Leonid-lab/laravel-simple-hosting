...
namespace  { 
            use Illuminate\Database\Eloquent\ModelNotFoundException;class App extends \Illuminate\Support\Facades\App {}
             ...
             * @static 
             */ 
            public static function findOrFail($id, $columns = []):\Illuminate\Database\Eloquent\Model|\Illuminate\Database\Eloquent\Collection|static
            {
                                /** @var \Illuminate\Database\Eloquent\Builder $instance */
             ...
             * @static 
             */ 
            public static function paginate($perPage = null, $columns = [], $pageName = 'page', $page = null):\Illuminate\Contracts\Pagination\LengthAwarePaginator
            {
                                /** @var \Illuminate\Database\Eloquent\Builder $instance */
